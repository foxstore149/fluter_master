 ...
 */
(function (w) {
  var PRIMARY_API = "https://flutter-master-api.foridur06.workers.dev";
  var BACKUP_API = "https://flutter-master-api.foridur06.workers.dev";
  var GAME_API = "https://flutter-master-api.foridur06.workers.dev";
  ...
  w.setApiBase = function (slotOrUrl) {
    ...
    if (/^(primary|workers|cf|cloudflare)$/i.test(next)) {
      next = strip(PRIMARY_API);
      try {
        w.localStorage.setItem("dfox_api_slot", "primary");
        w.localStorage.removeItem("dfox_api_base");
      } catch (e) {}
    } else if (/^(backup)$/i.test(next) && BACKUP_API) {
